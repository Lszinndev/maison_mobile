          ...
          <div className="p-6 bg-white border-t border-neutral-200 space-y-3 no-print">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12.012 2c-5.506 0-9.989 4.478-9.99 9.984a9.96 9.96 0 0 0 1.335 4.978L2 22l5.177-1.356a9.932 9.932 0 0 0 4.83 1.256h.005c5.507 0 9.991-4.479 9.992-9.986.002-2.67-1.037-5.18-2.93-7.071A9.904 9.904 0 0 0 12.012 2zm5.82 14.156c-.252.709-1.462 1.385-2.01 1.442-.497.052-1.144.072-1.84-.153a9.71 9.71 0 0 1-4.048-2.52 10.72 10.72 0 0 1-2.8-4.148c-.347-.59-.556-1.19-.556-1.784 0-1.22.637-1.826.865-2.05.173-.17.378-.255.567-.255.19 0 .378.005.541.013.167.008.39-.065.61.46.225.539.77 1.879.837 2.014.067.135.112.293.023.473-.09.18-.135.293-.27.45-.135.158-.285.352-.405.473-.135.135-.278.281-.12.551.157.27.7 1.15 1.503 1.864.802.714 1.48.934 1.795 1.092.315.158.495.135.675-.067.18-.203.77-.896.974-1.204.204-.308.406-.255.675-.157.27.098 1.714.808 2.008.956.293.148.49.22.56.34.07.12.07.695-.18 1.404z"/>
              </svg>
              Enviar no WhatsApp
            </button>
          </div>
